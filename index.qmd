...
- Worked Example 6.1: fixed typo in the calculation of the confidence interval

13 June 2024

- Table 1.6: added guidance on the acceptable number of decimal places for probabilities
- Module 2, Learning Outcome 3: replace with "Compute probabilities from a binomial distribution using statistical software"
- Module 2, Learning Outcome 4: replace with "Compute probabilities from a Normal distribution using statistical software"
 

9 June 2024

- Activity 1.3: Remove "mode" from Activity 1.3
- Section 3.3.1: Include example weights


22 May 2024

- Sections 2.15 and 2.24 - Overlaying a Normal curve on a histogram: remove
- Worked example 5.2: remove reference to Stata when calculating the difference between two variables, as this is a task that can be done in any software
- Figure 5.2: remove overlayed Normal curve
- Section 5.7: remove reference to overlaying a Normal curve
- Section 5.10: remove `ggformula` code and output
- Figure 8.5: remove overlayed Normal curve
- Module 8 R Notes: remove `ggformula` code and output
- Section 9.14: remove `ggformula` code and output
