...
To use Stata to perform the Chi-squared test on the data in `mod06_nausea.dta.dta` we need to have individual record data for the treatment group and presence of side effects. 
