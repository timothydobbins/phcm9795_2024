...
We will use data from `mod04_blood_pressure.csv` to demonstrate how a one-sample t-test is conducted in R.

```{r}
library(jmv)

bloodpressure <- read.csv("data/examples/mod04_blood_pressure.csv")
