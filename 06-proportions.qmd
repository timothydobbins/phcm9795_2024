...
### Worked example
The file `Example_6.3.csv` contains the data for this example. In the data file, smokers are coded as 1 and non-smokers are coded as 0.
