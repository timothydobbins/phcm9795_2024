...
```{r fig-mod09-lnlos, echo=FALSE, out.width = "66%", fig.cap="istribution of log transformed (length of stay + 1)"}
...
We will illustrate estimating rank correlation using the Stata file `mod08_lung_function.dta`, which has information about height and lung function collected from a sample of 120 adults.
