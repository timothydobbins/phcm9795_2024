...
hospstay <- readRDS("data/activities/Activity_S2.5-LengthOfStay.rds")

hist(hospstay$LengthStay, main=NA, xlab="Length of stay (days)")
boxplot(hospstay$LengthStay, main=NA, ylab="Length of stay (days)")
```

```{r, echo=FALSE, fig.pos="H", fig.height=8}
#| fig-cap: "Summary of length of hospital stay"

hospstay_males <- subset(hospstay, Sex=="male")
hospstay_females <- subset(hospstay, Sex=="female")

# Set the graphics parameters to plot 2 rows and 2 columns:
par(mfrow=c(2,2))

# Specify each plot separately
hist(hospstay_males$LengthStay, xlab="Length of stay (days)", main="Males",
     xlim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250), ylim=c(0, 60))
hist(hospstay_females$LengthStay, xlab="Length of stay (days)", main="Females",
     xlim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250), ylim=c(0, 60))
boxplot(hospstay_males$LengthStay, ylab="Length of stay (days)", main="Males",
     ylim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250))
boxplot(hospstay_females$LengthStay, ylab="Length of stay (days)", main="Females",
     ylim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250))
...
# Notice we specify the x-limits (from 0 to 250) and the breaks to keep
# the x-axes consistent
 
# We also specify the y-limits to keep the y-axes consistent

hist(hospstay_males$LengthStay, 
     xlab="Length of stay (days)", main="Males",
     xlim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250), 
     ylim=c(0, 60))

hist(hospstay_females$LengthStay, 
...
boxplot(hospstay_males$LengthStay,
        ylab="Length of stay (days)", main="Males",
        ylim=c(0, 250), breaks=c(0, 50, 100, 150, 200, 250))

boxplot(hospstay_females$LengthStay,
