...
To obtain the histograms in @fig-mod05-bwt-gender using the `Example_5.1.dta` data, go to **Graphics > Histogram**. Select `birthweight` as the **Variable** in the **Main** tab. Next go to the **By** tab, tick **Draw subgraphs for unique values of variable** and select `gender` as the **variable** as shown below:
