...
@tbl-ind-t summarises the results of an independent samples t-test using Example_5.1.dta. The process of conducting the t-test is summarised for Stata and R in the following sections.
