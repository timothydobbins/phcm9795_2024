...
```{r fig-cis-overlapping-null, echo=FALSE, out.width = "66%", fig.cap="Using confidence intervals as informal hypothesis tests"}
...
{{< include 04.1-hypothesis-testing-stata.qmd >}}
