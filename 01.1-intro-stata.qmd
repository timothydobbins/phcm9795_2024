...
Load the sample data set called `pbc.dta` into Stata using the following steps:
...
Here we will create the bar chart shown in @fig-bar-1 using the `pbc.dta` dataset. The x-axis of this graph will be the stage of disease, and the y-axis will show the number of participants in each category.
