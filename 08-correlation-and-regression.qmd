...
From Worked Example 8.1, we can be also plot a regression line through the scatter. @fig-scatter-plot-line shows the data overlayed with the fitted regression line.
