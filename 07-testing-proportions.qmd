<!-- NEED TO FIX UP SECTIONS AROUND USING TAB2 IN STATA, AND MAKE THINGS MORE SOFTWARE AGNOSTIC -->

<!-- FOR MCNEMAR'S TEST - ADD TEXT AROUND THE EXACT TEST BEING BASED ON BINOMIAL TEST -->
